...
> 20 |     expect(imgsize.height).toBeCloseTo(617, 0); //verifying the height of the product image in product details page is same as the height of the product image in product page
     |                            ^ Error: expect(received).toBeCloseTo(expected, precision)
