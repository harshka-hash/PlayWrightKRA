...
Locator:  locator('.footer_copy')
Expected: "© 2026 Sauce Labs. All Rights Reserved. Terms of Service | Privacy Policy"
Received: ""

Call log:
  - Expect "toHaveText" with timeout 10000ms
  - waiting for locator('.footer_copy')
...
> 24 |         await expect(this.page.locator(".footer_copy")).toHaveText("© 2026 Sauce Labs. All Rights Reserved. Terms of Service | Privacy Policy",{timeout: 10000});
     |                                                         ^ Error: expect(locator).toHaveText(expected) failed
  25 |     }
  26 | }
  27 | module.exports = {Footer};
```